...
public class Barco {	
	...
	private int filaInicial, columnaInicial;	// coordenadas iniciales del barco 
	private char orientacion;	// 'H': horizontal; 'V':vertical
	private int	tamanyo, tocadas;	// numero de casillas que ocupa
									// numero de casillas tocadas
